...
import memoryLane01 from "./assets/memorylane/AEUK5874.JPG";
import memoryLane02 from "./assets/memorylane/BIK01736-1-2.jpg";
import memoryLane03 from "./assets/memorylane/BIK01838.jpg";
import memoryLane04 from "./assets/memorylane/BIK01861.jpg";
import memoryLane05 from "./assets/memorylane/BIK02198.jpg";
import memoryLane06 from "./assets/memorylane/BIK02251.jpg";
import memoryLane07 from "./assets/memorylane/BIK02284-2.jpg";
import memoryLane08 from "./assets/memorylane/BIK0E9027.JPG";
import memoryLane09 from "./assets/memorylane/BIK0E9089.JPG";
import memoryLane10 from "./assets/memorylane/BIK0E9847.JPG";
import memoryLane11 from "./assets/memorylane/BIK0E9848.JPG";
import memoryLane12 from "./assets/memorylane/FQDO7707.JPG";
import memoryLane13 from "./assets/memorylane/GBWX3512.JPG";
import memoryLane14 from "./assets/memorylane/GCHS7398.JPG";
import memoryLane15 from "./assets/memorylane/GQDX1679.JPG";
import memoryLane16 from "./assets/memorylane/HUCQ1296.JPG";
import memoryLane17 from "./assets/memorylane/IMG_0082.JPG";
import memoryLane18 from "./assets/memorylane/IMG_0138 1.JPG";
import memoryLane19 from "./assets/memorylane/IMG_0604.JPG";
import memoryLane20 from "./assets/memorylane/IMG_0628 1.JPG";
import memoryLane21 from "./assets/memorylane/IMG_0641 1.JPG";
import memoryLane22 from "./assets/memorylane/IMG_0661.JPG";
import memoryLane23 from "./assets/memorylane/IMG_0690.JPG";
import memoryLane24 from "./assets/memorylane/IMG_0737.JPG";
import memoryLane25 from "./assets/memorylane/IMG_0746.JPG";
import memoryLane26 from "./assets/memorylane/IMG_0790.JPG";
import memoryLane27 from "./assets/memorylane/IMG_0809 1.JPG";
import memoryLane28 from "./assets/memorylane/IMG_0862.JPG";
import memoryLane29 from "./assets/memorylane/IMG_0936.JPG";
import memoryLane30 from "./assets/memorylane/IMG_1008.JPG";
import memoryLane31 from "./assets/memorylane/IMG_1036.JPG";
import memoryLane32 from "./assets/memorylane/IMG_1145.JPG";
import memoryLane33 from "./assets/memorylane/IMG_1177.JPG";
import marriage01 from "./assets/marriage/BIK0E9089.JPG";
...
function App() {
  ...
  const [activeMarriageSlide, setActiveMarriageSlide] = useState(0);
    ...
    () => [
      {
        ...
        note: "Sunlight, soft steps, and the way your hand fits in mine like it was always meant to.",
      },
      {
        id: "memory-02",
        image: memoryLane02,
        title: "Precious Moments",
        note: "Every frame captures a piece of our beautiful journey together.",
      },
      {
        id: "quiet-coffee",
        image: memoryLane03,
        title: "Quiet Coffee",
        note: "A small table, warm cups, and a conversation that made the whole day feel gentle.",
      },
      {
        id: "memory-04",
        image: memoryLane04,
        title: "Together Always",
        note: "In your arms, I found my forever home.",
      },
      {
        id: "hand-in-hand",
        image: memoryLane05,
        title: "Hand in Hand",
        note: "Every path feels easy when it is traced with you beside me.",
      },
      {
        id: "sunset-promise",
        image: memoryLane06,
        title: "Sunset Promise",
        note: "The sky turned gold and pink, and I wished for a thousand more nights like this.",
      },
      {
        id: "memory-07",
        image: memoryLane07,
        title: "Our Story",
        note: "Written in smiles, sealed with love, and treasured forever.",
      },
      {
        id: "memory-08",
        image: memoryLane08,
        title: "Perfect Moment",
        note: "With you, every second feels like a highlight.",
      },
      {
        id: "laughing-eyes",
        image: memoryLane09,
        title: "Laughing Eyes",
        note: "That sparkle in your eyes is my favorite kind of magic.",
      },
      {
        id: "memory-10",
        image: memoryLane10,
        title: "Love's Glow",
        note: "You light up my world in ways words can never express.",
      },
      {
        id: "memory-11",
        image: memoryLane11,
        title: "Us",
        note: "The best love story is the one we're living together.",
      },
      {
        id: "soft-morning",
        image: memoryLane12,
        title: "Soft Morning",
        note: "Slow mornings, shared smiles, and a calm that feels like home.",
      },
      {
        id: "memory-13",
        image: memoryLane13,
        title: "Beautiful Day",
        note: "Every day is more beautiful when I spend it with you.",
      },
      {
        id: "memory-14",
        image: memoryLane14,
        title: "Timeless",
        note: "Moments with you are forever burned in my heart.",
      },
      {
        id: "memory-15",
        image: memoryLane15,
        title: "Forever Us",
        note: "I choose you, today and every day after.",
      },
      {
        id: "memory-16",
        image: memoryLane16,
        title: "My Person",
        note: "You're not just my love, you're my favorite person.",
      },
      {
        id: "memory-17",
        image: memoryLane17,
        title: "Radiant",
        note: "Your smile is the reason my heart keeps skipping beats.",
      },
      {
        id: "memory-18",
        image: memoryLane18,
        title: "Sweet Memories",
        note: "Collecting moments with you like precious gems.",
      },
      {
        id: "memory-19",
        image: memoryLane19,
        title: "Adventure",
        note: "Life is an adventure when I'm with you.",
      },
      {
        id: "memory-20",
        image: memoryLane20,
        title: "Pure Joy",
        note: "Your presence is my favorite kind of happiness.",
      },
      {
        id: "memory-21",
        image: memoryLane21,
        title: "Soulmate",
        note: "I found my soulmate, and it's you.",
      },
      {
        id: "memory-22",
        image: memoryLane22,
        title: "Blessed",
        note: "Grateful for every second I get to spend with you.",
      },
      {
        id: "city-lights",
        image: memoryLane23,
        title: "City Lights",
        note: "Even the brightest nights glow warmer when you are there.",
      },
      {
        id: "memory-24",
        image: memoryLane24,
        title: "Breathtaking",
        note: "You take my breath away, always.",
      },
      {
        id: "memory-25",
        image: memoryLane25,
        title: "Growing Together",
        note: "With you, I'm becoming the best version of myself.",
      },
      {
        id: "memory-26",
        image: memoryLane26,
        title: "Endless Love",
        note: "My love for you is limitless and eternal.",
      },
      {
        id: "memory-27",
        image: memoryLane27,
        title: "Dream Come True",
        note: "You're everything I've ever dreamed of and more.",
      },
      {
        id: "memory-28",
        image: memoryLane28,
        title: "Cherish",
        note: "Every moment with you is one I'll cherish forever.",
      },
      {
        id: "memory-29",
        image: memoryLane29,
        title: "Home",
        note: "Wherever you are, that's where my home is.",
      },
      {
        id: "memory-30",
        image: memoryLane30,
        title: "Together",
        note: "We're stronger together than apart.",
      },
      {
        id: "memory-31",
        image: memoryLane31,
        title: "Always",
        note: "You're my always, my forever, my everything.",
      },
      {
        id: "forever-frame",
        image: memoryLane32,
        title: "Forever Frame",
        note: "A moment I want to hold on to, the kind that never fades.",
      },
      {
        id: "memory-33",
        image: memoryLane33,
        title: "Our Love",
        note: "Oh my personal model, you are the most beautiful thing I have ever seen, inside and out. Loving you is the best part of my life, and I can't wait to see where our love takes us next.",
      },
    ],
    [],
  );

  const marriageSlides = useMemo(
    () => [
      {
        id: "marriage-moment",
        image: marriage01,
        title: "Our Wedding Day",
        note: "The day we promised forever, surrounded by love and joy. You looked absolutely breathtaking.",
      },
    ],
    [],
  );
    ...
    <div className="page">
        ...
        <div className="timeline-track">
          <div className="timeline-item">
            ...
            <div>
              ...
              <p>
                The day my heart learned your name, love at first eye sight{" "}
                <b>AGAAAAAIN ❤️</b>
              </p>
              <iframe
                title="NJP Location"
          ...
          <div className="timeline-item">
            ...
            <div>
              ...
              <img
                ...
                alt="Two love birds talking with love"
                className="love-birds-img"
              />
            </div>
          </div>
          <div className="timeline-item">
          ...
          <div className="timeline-item">
            ...
            <div>
              ...
              <img
                src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXU3am4yNDA3YzBvMnd1ZWEzaW04bzRmemV2ZnU2d200cDF2MjR3dyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/46bOASEEnV5y8/giphy.gif"
                alt="Panda falling from tree"
                style={{ borderRadius: "8px", marginTop: "8px", width: "100%" }}
              />
            </div>
          </div>
        </div>
      ...
      <section className="final">
        ...
        <div style={{ textAlign: "center", marginTop: "2rem" }}>
          ...
          >
            "In you, I've found my home, my love, and my greatest adventure."
          </p>
          <p
            style={{
              fontSize: "1.1rem",
          ...
          >
            Thank you for choosing to walk this journey with me. You've turned
            my ordinary days into extraordinary memories, my lonely moments into
            warmth, and my uncertain future into a beautiful adventure I can't
            wait to live.
          </p>
          <p
            style={{
          ...
          >
            I promise to love you fiercely, support you endlessly, laugh with
            you freely, and cherish you completely - today and every day after.
          </p>
          <p
            style={{
              fontSize: "1.15rem",
          ...
          >
            You are my favorite person, my greatest blessing, and my forever
            choice. ❤️
          </p>
        </div>
      </section>
